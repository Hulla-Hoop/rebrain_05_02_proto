...
type PdfComposeServiceClient interface {
	Send(ctx context.Context, in *Upfile, opts ...grpc.CallOption) (*File, error)
}
...
func (c *pdfComposeServiceClient) Send(ctx context.Context, in *Upfile, opts ...grpc.CallOption) (*File, error) {
	out := new(File)
...
type PdfComposeServiceServer interface {
	Send(context.Context, *Upfile) (*File, error)
...
func (UnimplementedPdfComposeServiceServer) Send(context.Context, *Upfile) (*File, error) {
...
func _PdfComposeService_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PdfComposeServiceServer).Send(ctx, req.(*Upfile))
	}
